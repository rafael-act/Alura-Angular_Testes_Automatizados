...
describe(PhotoFrameComponent.name, () => {
  ...
  it(`(DOM) Should display number of likes when (@Input)likes is incremented`, () => {
    fixture.detectChanges();//para o ngoninit ciclo de vida
    component.likes++;
    fixture.detectChanges();//reload na tela
  ...
  it(`(DOM) Should display image src and description when bound to properties`, () => {
    const description = 'some description';
    const src = 'http://somesitem.com.br/img.jpg';
    component.src = src;
